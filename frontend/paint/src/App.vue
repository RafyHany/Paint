          ...
          <div class="sidenavshape" ref="sidenavshape">
              ...
              <ul class="buttonshape">
                  <li>
                      ...
                      <button class="shapes" id="square" @click="handleShape(1)">Square</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/rectangle.png" alt="">
                      <button class="shapes" id="rectangle" @click="handleShape(2)">Rectangle</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/triangle.svg" alt="">
                      <button class="shapes" id="triangle" @click="handleShape(4)">Triangle</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/circle.svg" alt="">
                      <button class="shapes" id="circle" @click="handleShape(5)" >Circle</button>
                  </li>
                  
                  <li>
                      <img class="images" src="./assets/ellipse.png" alt="">
                      <button class="shapes" id="ellipse" @click="handleShape(3)">Ellipse</button>
                  </li>
                  
                  <li>
                      <img class="images" src="./assets/line.png" alt="">
                      <button class="shapes" id="line" @click="handleShape(6)" >Line</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/pentagon.png" alt="">
                      <button class="shapes" id="pentagon" @click="handleShape(7)" >Pentagon</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/hexagon.png" alt="">
                      <button class="shapes" id="hexagon" @click="handleShape(8)">Hexagon</button>
                  </li>
                  <li>
                      <img class="images" src="./assets/brush.svg" alt="">
                      <button class="shapes" id="brush" @click="handleBrush">brush</button>
                  </li>
              </ul>
          </div>
          ...
          <div class="sidenavoption">
              ...
              <ul>
                ...
                <li>
                    ...
                    <button class="options" id="erase" @click="handleFlags(1, 0, 0)">Erase</button>
                </li>
                <li>
                    <img class="images" src="./assets/copy.png" alt="">
                    <button class="options" id="copy"  @click="handleFlags(0, 1, 0)"  >Copy</button>
                </li>
                <li>
              ...
              <form>
                  ...
                  <input type="color" id="color" value="#ededed" @click="handleFlags(0, 0, 1)">
              </form>
          </div>
      </div>
  </body>
...
export default {
  ...
  methods:{
    handleMouseUp(){
        this.mouseDown = 0
        this.initial = 1
        if(this.usingBrush == 1){
            this.usingBrush = 0
            var color = document.getElementById("color").value;
            var line = ({
            points: this.arrayOfPts,
            stroke: color,
            strokeWidth: 10,
            lineCap: 'round',
            lineJoin: 'round',
            ...
            var indexOfLine = this.lines.findIndex((obj) => obj.id === String(this.id))
            this.lines = this.lines.slice(0, indexOfLine)
    ...
    handleFlags(deleteFlag, copyFlag, colorFlag){
    ...
    handleShape(shapeNumber){
        var brush = document.getElementById('brush').style
        if(this.shapeVariable == 9){
            brush.color = 'rgb(2,0,2)'
            brush.backgroundColor = '#e9eef0'
        }
        if(shapeNumber >= 1 && shapeNumber <= 8)
            this.shapeVariable = shapeNumber
        else
            this.shapeVariable = 0
    },

    handleBrush(){
        console.log(this.shapeVariable)
        var brush = document.getElementById('brush').style
        if(this.shapeVariable == 9){
            this.shapeVariable = 0
            brush.color = 'rgb(2,0,2)'
            ...
            this.shapeVariable = 9
            brush. color = 'rgb(243, 290, 255)';  
            brush.backgroundColor = "rgb(0, 0, 0)";
        }
    },
    handleMouseMove(e){
        var color = document.getElementById("color").value;
      ...
      if(this.mouseDown == 1 && this.initial == 1 && this.shapeVariable == 9){
        this.initial = 0
        this.usingBrush = 1
        this.arrayOfPts.push(event.clientX-offsetWidthCanvas)
        this.arrayOfPts.push(event.clientY-offsetHeightCanvas)

        var line = ({
            points: [event.clientX-offsetWidthCanvas, event.clientY-offsetHeightCanvas,
                event.clientX-offsetWidthCanvas, event.clientY-offsetHeightCanvas],
            stroke: color,
            strokeWidth: 10,
            lineCap: 'round',
            lineJoin: 'round',
      ...
      else if(this.mouseDown == 1 && this.shapeVariable == 9){
        this.arrayOfPts.push(event.clientX-offsetWidthCanvas)
        this.arrayOfPts.push(event.clientY-offsetHeightCanvas)
        var line = ({
            points: [this.oldX-offsetWidthCanvas, this.oldY-offsetHeightCanvas,
                event.clientX-offsetWidthCanvas, event.clientY-offsetHeightCanvas],
            stroke: color,
            strokeWidth: 10,
            lineCap: 'round',
    ...
    createElement(event){
        if(this.shapeVariable == 9){return}
        this.colorFlag = 0
        this.copyFlag = 0
        this.deleteFlag = 0
        var color = document.getElementById("color").value;
